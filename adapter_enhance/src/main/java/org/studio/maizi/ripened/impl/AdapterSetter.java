...
import org.studio.maizi.ripened.IAdapter;
...
public class AdapterSetter implements IAdapter {
    ...
    public void action(ActionParams params) {
        org.studio.maizi.ripened.anno.Adapter annoAdpt = null;
        if ((annoAdpt = params.getField().getAnnotation(org.studio.maizi.ripened.anno.Adapter.class)) != null) {
