...
import org.studio.maizi.rapefield.IAdapter;
...
public class AdapterSetter implements IAdapter {
    ...
    public void action(ActionParams params) {
        org.studio.maizi.rapefield.anno.Adapter annoAdpt = null;
        if ((annoAdpt = params.getField().getAnnotation(org.studio.maizi.rapefield.anno.Adapter.class)) != null) {
