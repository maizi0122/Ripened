...
package org.studio.maizi.ripeneddemo;
...
import org.studio.maizi.ripened.anno.Adapter;
import org.studio.maizi.ripened.anno.Anim;
import org.studio.maizi.ripened.anno.ContentView;
...
public class AdapterViewActivity3 extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ripend = new Ripened().inject(this, new CustomAdapter(list)); //if your Adapter class have no empty-param constructor,you should pass the instance in
